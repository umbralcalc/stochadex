...
|---|---|---|
| <img src="./assets/postgres-integration-logo.svg" height="40"/><br/> | Load state history into a simulation and write output back over `database/sql` — built into the engine. Point it at any Postgres-wire database (PostgreSQL, TimescaleDB, QuestDB) by supplying your own `*sql.DB`. | [read](https://stochadex.github.io/pkg/analysis.html#NewStateTimeStorageFromPostgresDb) · [write](https://stochadex.github.io/pkg/analysis.html#NewPostgresDbOutputFunction) |
