...
- Sampling from arbitrary posterior densities using simulations: [https://umbralcalc.github.io/posts/stochadexIV.html](https://umbralcalc.github.io/posts/stochadexIV.html).
