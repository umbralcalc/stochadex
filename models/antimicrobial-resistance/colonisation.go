...
//
// The iterations in this file (and infection.go) are BESPOKE EXTENSIONS written
...
// be promoted into core?" question. They are lifted verbatim from the downstream
// project repo so the comparison across models stays honest — see card.md for the
// downstream pointer.
package amr
